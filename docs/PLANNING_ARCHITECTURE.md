...
| Vue flotte | Partiel | Opérationnel P0.2 | Navires en lignes ; opérations typées, lieux quotidiens et dépôt direct d’un marin non affecté ; aucun libellé marin dans la timeline | Maintenir |
...
| Affectations | Partiel | Opérationnel P0.3 | Fonction, instants, statut provisoire/confirmé, modification/retrait et dépôt Flotte simplifié ; détail dans Équipages | Maintenir |
