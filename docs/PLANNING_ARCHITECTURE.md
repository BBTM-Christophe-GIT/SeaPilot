...
La vue Flotte réutilise désormais le langage visuel compact de la vue Équipages : hauteurs de lignes homogènes, accent vert d’eau, compteurs discrets et barres de projet fines avec libellé centré. Cette harmonisation reste strictement visuelle ; la sélection au clic gauche, le menu d’état au clic droit, l’ouverture du formulaire complet au double-clic, le glisser-déposer et le redimensionnement conservent leurs gestionnaires existants.
