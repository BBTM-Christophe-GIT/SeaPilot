...
- `planningCrewList.ts` sélectionne une bordée à une date depuis l’instantané Supabase et génère une crew list Excel ou PDF A4 paysage sans lire les données du fichier modèle fourni.
