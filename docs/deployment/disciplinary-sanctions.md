...
5. L’émetteur actuel ou Administration peut changer l’émetteur vers un profil Administration/Direction autorisé, directement dans la liste **Prénom et NOM de l’émetteur** au pied du courrier ou dans **Relecture et partage**. Le nom et la fonction sont issus du profil ; l’ancienne signature est effacée et le nouvel émetteur est notifié. Les modifications locales sont enregistrées avant transfert, même pour un nouveau dossier ; celles d’un relecteur restent des propositions. Si l’enregistrement ou le transfert échoue, l’identité ne change pas. Les courriers validés conservent leur signataire historique.
