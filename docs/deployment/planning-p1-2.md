...
- `admin`, `direction` et `armement` peuvent demander/valider/refuser une absence et traiter les conflits de l’entreprise ;
- `capitaine` peut demander sa propre absence et traiter les conflits des navires dont il a la charge sur la période ;
...
3. Créer une demande qui passe minuit et confirmer les instants UTC et l’affichage local.
...
10. Refaire les lectures/écritures avec un marin, un capitaine et un utilisateur d’une autre entreprise pour confirmer les limites RLS.
11. Valider le panneau sur un écran 15 pouces et un viewport iPad 12,9 pouces, avec des cibles tactiles d’au moins 44 px.
