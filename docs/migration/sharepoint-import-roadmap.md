...
- Module Procédures QHSE placé dans le menu QHSE et raccordé à `procedures`, `published_procedures` et au bucket privé `procedure-documents`. Administration/Direction gèrent les sources ; Armement/Capitaine/Marin ne voient que les PDF publiés. Le détail de migration et de recette est décrit dans [qsms-procedures.md](./qsms-procedures.md).
