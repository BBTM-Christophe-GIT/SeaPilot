...
export function ExpenseNotesPage() {
  ...
  return <section className="expense-page">
    ...
    {creating && identity ? <ExpenseNoteForm identity={identity} vessels={vessels} people={directory} settings={settings} defaultVesselId={defaultVesselId} functionLabel={context.currentPerson?.functionLabel || ''} onClose={() => setCreating(false)} onSubmit={submit} /> : null}
