      ...
      <div className="fcx-report-dialog-body">
        ...
        <section className="fcx-report-content-section" aria-labelledby="fleet-report-content-title">
          ...
          <div className="fcx-report-content-options">
            ...
            <label className={includeFindings ? 'is-active' : ''}><input checked={includeFindings} onChange={(event) => setIncludeFindings(event.target.checked)} type="checkbox" /><Flag size={18} /><span><b>Liste des écarts</b><small>Synthèse, actions correctives et un écart par page</small></span></label>
          </div>
