...
export const QHSE_REPORT_CATALOG: readonly QhseReportDefinition[] = [
  ...
  { id: 'social-governance', pageNumber: 6, sourcePage: 8, sourceTitle: 'RSE - Social Gouvernance', title: 'Indicateur RSE — Social et Gouvernance', family: 'QHSE & RSE', description: 'Bien-être agrégé, droits humains, propositions ESG sélectionnées et commentaire de la Direction.', orientation: 'portrait', coverage: 'complete' },
