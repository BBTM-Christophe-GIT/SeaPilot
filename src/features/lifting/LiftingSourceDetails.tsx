...
export function LiftingSourceDetails({ item }: { item: LiftingItem }) {
  ...
  return <details className="lifting-source-details"><summary>Historique du registre source</summary><dl>
    ...
    <div><dt>Ancienne périodicité</dt><dd>{source.inspection_frequency || 'Non renseignée'}</dd></div>
  ...
  </dl><p>Informations historiques importées. Le suivi actuel des visites est annuel.</p></details>;
}
