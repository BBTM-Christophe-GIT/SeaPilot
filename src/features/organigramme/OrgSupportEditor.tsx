...
import { orgCategoryLabel, type OrgData, type OrgSupport } from './organigrammeModel';
...
export function OrgSupportEditor({ client, data, onSaved, previewMode }: { client: SupabaseClient; data: OrgData; onSaved: () => void; previewMode: boolean }) {
  ...
  return <section className="org-editor" aria-label="Structure complémentaire"><h2>Responsabilités et intervenants</h2><p>Les responsabilités ci-dessous reprennent le document de référence et peuvent être actualisées. Une fiche RH liée conserve le nom à jour. Les équipages se modifient dans le Planning.</p>
