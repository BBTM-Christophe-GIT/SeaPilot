...
export function PlanningP12Panel({
  ...
  return (
    <div className="planning-p12-modal">
      <AppDialog
      ...
      >
        <div className="planning-p12-panel">
