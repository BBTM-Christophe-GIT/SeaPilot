  ...
  async function submitPolicy(event: FormEvent) {
    ...
    try {
      await savePlanningWorkRestPolicy(client, {
        ...
        maxWork24h: requiredPolicyNumber(policyEditor.maxWork24h, 'Le maximum de travail sur 24 h glissantes'),
