...
export function PlanningP13Panel({
  ...
  const filteredChecks = useMemo(() => checks.filter((check) => restFilter === 'all'
    || (restFilter === 'alerts' && ['non_compliant', 'derogated'].includes(check.status))
