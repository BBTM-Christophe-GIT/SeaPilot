...
function fixture(): { overview: PlanningOverview; data: PlanningP13Data } {
  ...
  const data: PlanningP13Data = {
    ...
    p12: {
      ...
      matrices: [{ id: 70, vesselId: 10, name: 'Armement', navigationGenre: 'CN-CABOTAGE NATIONAL', activityDescription: 'Navigation côtière', effectiveFrom: '2026-01-01', effectiveTo: '', status: 'active', notes: '', version: 1, requirements: [{ id: 71, matrixId: 70, functionLabel: 'Capitaine', minimumCount: 1, targetCount: 1, requiredCertificates: ['Capitaine 3000'], requiredQualifications: ['Grue offshore'], requiredAuthorizations: [], requiredTrainings: [], restrictions: [], displayOrder: 0 }] }],
    },
  };
