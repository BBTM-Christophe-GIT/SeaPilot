    ...
    const batch = buildSharePointUpsertBatch('library-brevets-visites-medicales', [
      {
        ...
        fields: {
          ...
          RestrictionM_x00e9_dicale: '2eme Categorie',
          VeillePasserelle: false,
          InapteNavigation: false,
          File_x0020_Size: '682463',
      ...
      rows: [
        {
          ...
          category_label: null,
          document_title: 'Permis de navigation COTENTIN.pdf',
          ...
          renewal_notes: null,
          original_file_name: 'Permis de navigation COTENTIN.pdf',
          file_name: 'Permis de navigation COTENTIN.pdf',
    ...
    const batch = buildSharePointUpsertBatch('library-qsms', [
      {
        ...
        fields: {
          ...
          'Catégorie': 'Procédure d’urgence',
          'Date diffusion': '2026-01-11T00:00:00Z',
          Description: 'Gestion des non-conformités',
          'Exigence Réglementaire': 'Code ISM',
          'ISM Chapitre': '09 - Rapports et analyse',
          Navire: { Title: 'LE ROZEL' },
          Projet: 'P144',
          Projet_LK: [
            { Title: 'P144 - GUARD VESSEL EMDT' },
            { LookupValue: 'P145 - OIL SPILL SAIPEM COU' },
          ],
          'Numéro': 'PRO-09-A',
          Restrictions: 'Diffusion interne',
          'Revue annuelle': true,
          "Statut d'approbation": 'Document approuve',
          'Thème': 'URG',
          'Type document': 'PRO',
          'Veille Passerelle': true,
        },
      },
    ]);
      ...
      rows: [
        {
          ...
          diffusion_on: '2026-01-11',
          description: 'Gestion des non-conformités',
          regulatory_requirement: 'Code ISM',
          ism_chapter: '09 - Rapports et analyse',
          vessel_name: 'LE ROZEL',
          project_name: 'P144 - GUARD VESSEL EMDT; P145 - OIL SPILL SAIPEM COU',
          document_number: 'PRO-09-A',
          restrictions: 'Diffusion interne',
          annual_review: true,
    ...
    const batch = buildSharePointUpsertBatch('library-qsms-pdf', [
      {
        ...
        fields: {
          ...
          Statut: 'Publie',
          DatePublication: '2026-01-10T00:00:00Z',
          Navire: { LookupValue: 'GOURY' },
          Projet: 'P144',
          Projet_LK: [{ Title: 'P144 - GUARD VESSEL EMDT' }],
        },
      },
    ]);
