alter table public.fleet_certificate_findings
  drop constraint if exists fleet_certificate_findings_finding_type_check;
...
comment on constraint fleet_certificate_findings_finding_type_check
  ...
  'Types d’écarts et de constats acceptés par le module Certificats flotte, observation comprise.';
