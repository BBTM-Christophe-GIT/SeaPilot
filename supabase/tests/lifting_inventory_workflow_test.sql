...
begin
  ...
  foreach uid in array array['9e090000-0000-0000-0000-000000000004'::uuid,'9e090000-0000-0000-0000-000000000005'::uuid] loop
    ...
    assert exists(select 1 from public.lifting_available_vessels() v where v.id=vessel
      and v.photo_url='/vessels/existing.jpg' and v.photo_storage_path is null
      and v.illustration_storage_bucket='fleet-media' and v.illustration_storage_path=c||'/'||vessel||'/fixture.png'
      and v.illustration_thumbnail_url='/vessels/bbtm/fixture-0123456789abcdef.webp'), 'Assigned profile receives thumbnail and additional illustration metadata, independently of its primary photo';
